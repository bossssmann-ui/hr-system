...
run('bun', ['test', 'src/auth/auth.integration.test.ts', 'src/features/requisitions/requisitions.rls.integration.test.ts', 'src/features/recruiting.routes.integration.test.ts', 'src/features/phase1b.rls.integration.test.ts', 'src/features/assessments/assessments.routes.integration.test.ts', 'src/features/applications/composite-score.integration.test.ts', 'src/features/employees/lifecycle.rls.integration.test.ts', 'src/features/employees/probation-review.routes.integration.test.ts', 'src/features/performance/review.routes.integration.test.ts', 'src/features/performance/okr.routes.integration.test.ts', 'src/features/performance/idp.routes.integration.test.ts', 'src/features/pipeline.integration.test.ts'], { env })
