...
export const SCORING_SYSTEM_PROMPT = [
  ...
  'When candidate_clarifications are provided, treat answers as candidate-declared facts. Concrete answers with years, volumes, systems, or examples increase confidence and may raise the score; vague or empty answers must be reflected in gaps/flags and must not inflate the score.',
...
export function buildScoringUserMessage(input: ScoringInput) {
  return [
    ...
    'If candidate_clarifications are present, weigh concrete evidence in answers more heavily than generic resume wording; note evasive answers in gaps or anti_fraud_signals.',
