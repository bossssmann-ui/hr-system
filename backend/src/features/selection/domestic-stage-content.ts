...
const DIST_STAGE_2: TestStageContent = {
  ...
  questions: [
    {
      key: 'dist_q_sla_otif',
      text: 'SLA / OTIF в развозке означают:',
      type: 'radio',
      options: [
        'Тип кузова и температурный режим.',
        'Уровень сервиса и долю заказов, доставленных вовремя и в полном объёме.',
        'Формат страхового полиса.',
        'Вид тарифа по километражу.',
      ],
      correct: 'Уровень сервиса и долю заказов, доставленных вовремя и в полном объёме.',
      weight: 2,
    },
    {
      key: 'dist_q1',
    ...
    {
      key: 'dist_q_docs_partial',
      text: 'При частичном отказе или недовозе на точке нужно:',
      type: 'radio',
      options: [
        'Закрыть заказ полностью без фиксации.',
        'Зафиксировать расхождения и оформить документы по фактически принятому объёму.',
        'Попросить водителя решить на месте устно.',
        'Оставить корректировки до конца месяца.',
      ],
      correct: 'Зафиксировать расхождения и оформить документы по фактически принятому объёму.',
      weight: 2,
    },
    {
      key: 'dist_q4',
    ...
    {
      key: 'dist_q_wms_open',
      text: 'Работали ли с WMS / сканированием / штрихкодами при развозке? Как именно?',
      type: 'textarea',
      weight: 5,
    },
  ],
...
const RAIL_STAGE_2: TestStageContent = {
  ...
  questions: [
    {
      key: 'rail_q_etran',
      text: 'ЭТРАН в ЖД-логистике — это:',
      type: 'radio',
      options: [
        'Биржа грузоперевозок.',
        'Электронная система оформления перевозочных документов и подачи заявок РЖД.',
        'Складская WMS система.',
        'Таможенная база данных.',
      ],
      correct: 'Электронная система оформления перевозочных документов и подачи заявок РЖД.',
      weight: 2,
    },
    {
      key: 'rail_q_gu12',
      text: 'Заявка ГУ-12 используется для:',
      type: 'radio',
      options: [
        'Оформления акта о повреждении груза.',
        'Заявки на ЖД-перевозку (согласование объёма и направления с перевозчиком).',
        'Таможенного декларирования.',
        'Аренды вагона.',
      ],
      correct: 'Заявки на ЖД-перевозку (согласование объёма и направления с перевозчиком).',
      weight: 2,
    },
    {
      key: 'rail_q_etsng',
      text: 'Код ЕТСНГ нужен для:',
      type: 'radio',
      options: [
        'Классификации груза и расчёта ЖД-тарифа.',
        'Определения кода станции отправления.',
        'Учёта номера контейнера.',
        'Идентификации получателя.',
      ],
      correct: 'Классификации груза и расчёта ЖД-тарифа.',
      weight: 2,
    },
    {
      key: 'rail_q1',
    ...
    },
    {
      ...
      text: 'Какое утверждение верно про типы контейнеров?',
      type: 'radio',
      options: [
        "20' и 40' имеют одинаковую вместимость, отличаются только стоимостью.",
        "40'HC — high cube, выше стандартного 40' примерно на 1 фут и удобен для объёмных грузов.",
        'Рефконтейнер не подходит для температурных грузов.',
        "20' используется только для международных перевозок.",
      ],
      correct:
        "40'HC — high cube, выше стандартного 40' примерно на 1 фут и удобен для объёмных грузов.",
      weight: 2,
    },
    {
      ...
      text: 'Демередж / детенция / терминальное хранение — это:',
      type: 'radio',
      options: [
        'Единый фиксированный тариф без бесплатного периода.',
        'Плата за сверхнормативное использование/простой контейнера и хранение сверх free-time.',
        'Только штраф за опоздание водителя.',
        'Комиссия за оформление ЖД накладной.',
      ],
      correct:
        'Плата за сверхнормативное использование/простой контейнера и хранение сверх free-time.',
      weight: 2,
  ...
  questions: [
    {
      ...
      text: 'Когда груз относится к негабаритному при автоперевозке?',
      type: 'radio',
      options: [
        'Только если масса больше 20 тонн.',
        'При превышении ширины 2.55 м, высоты 4 м, выступа сзади > 2 м и/или предельной длины автопоезда.',
        'Только при превышении высоты.',
        'Это определяет водитель на погрузке.',
      ],
      correct:
        'При превышении ширины 2.55 м, высоты 4 м, выступа сзади > 2 м и/или предельной длины автопоезда.',
      weight: 2,
    },
    {
      ...
      text: 'Допустимая длина автопоезда без спецразрешения (базовый ориентир):',
      type: 'radio',
      options: ['12 м', '16,5 м', '20 м', '24 м'],
      correct: '20 м',
      weight: 2,
    },
    {
      key: 'oversized_q_permit_authority',
      text: 'Кто оформляет спецразрешение на перевозку КТГ/тяжеловеса?',
      type: 'radio',
      options: [
        'Только водитель на посту.',
        'Уполномоченные дорожные органы (Росавтодор/региональные органы) по маршруту.',
        'Только грузоотправитель после рейса.',
        'Любой экспедитор без согласований.',
      ],
      correct: 'Уполномоченные дорожные органы (Росавтодор/региональные органы) по маршруту.',
      weight: 2,
    },
    {
      key: 'oversized_q_axle_load',
      text: 'Почему осевые нагрузки критичны для КТГ?',
      type: 'radio',
      options: [
        'Они не влияют, если есть страховка.',
        'Превышение разрушает дороги/мосты, влечёт штрафы и требует расчёта маршрута с разрешением.',
        'Нужны только для расчёта топлива.',
        'Важны только при международной перевозке.',
      ],
      correct:
        'Превышение разрушает дороги/мосты, влечёт штрафы и требует расчёта маршрута с разрешением.',
      weight: 2,
...
const CABOTAGE_STAGE_2: TestStageContent = {
  ...
  questions: [
    ...
    {
      key: 'cab_q_document',
      text: 'Базовый документ на морском плече в каботаже:',
      type: 'radio',
      options: [
        'CMR',
        'CMR + ТТН',
        'Морская накладная / коносамент (B/L)',
        'Таможенная декларация',
      ],
      correct: 'Морская накладная / коносамент (B/L)',
      weight: 2,
    },
    {
      key: 'cab_q_svh',
      text: 'Нужен ли СВХ при каботаже между портами РФ?',
      type: 'radio',
      options: [
        'Да, обязателен для любой партии.',
        'Нет, внутри РФ таможенного оформления нет; применяются правила портового хранения.',
        'Нужен только при LTL.',
        'Всегда нужен таможенный брокер.',
      ],
      correct: 'Нет, внутри РФ таможенного оформления нет; применяются правила портового хранения.',
      weight: 2,
    },
    {
      key: 'cab_q_free_period',
      text: 'Что верно про портовое хранение в каботаже?',
      type: 'radio',
      options: [
        'Всегда бесплатно без ограничений.',
        'Всегда платно с первого дня.',
        'Есть бесплатный период, а сверх него действует платное хранение по правилам конкретного порта.',
        'Во всех портах РФ единый норматив free-time.',
      ],
      correct:
        'Есть бесплатный период, а сверх него действует платное хранение по правилам конкретного порта.',
      weight: 2,
